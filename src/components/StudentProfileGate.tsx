...
import { User, School, BookOpen, ArrowRight, MapPin, GraduationCap, ShieldCheck, Eye, EyeOff, Lock } from 'lucide-react';
...
export default function StudentProfileGate({ children }: { children: React.ReactNode }) {
  const { isTeacherMode, loginWithTeacherCode } = useAuth();
